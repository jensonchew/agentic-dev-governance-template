...
**Then ask: what would have prevented this bug?** If the answer involves architectural change, note it for follow-up. Make the recommendation **after** the fix is in — you have more information now than when you started.
